...
La page [Overrider un modèle](/fr/03-comptoir-architecture/08-overrider-un-modele) décrit le mécanisme complet.

La page [Contrats de données](/fr/03-comptoir-architecture/12-contrats-de-donnees) décrit les vérifications à faire.
